...
<head>
    ...
    <script language="javascript" src="admin/lib/js/jquery-3.3.1.js"></script>
    <script language="javascript" src="admin/lib/js/jquery-validation-1.17.0/dist/jquery.validate.js"></script>
    <script language="javascript" src="admin/lib/js/jquery-validation-1.17.0/dist/jquery.validate.min.js"></script>
    <script language="javascript" src="admin/lib/js/jquery-validation-1.17.0/dist/additional-methods.min.js"></script>
